const members = [
    ...
    },
    {
    ...
    },
     {
        ...
        skills: ["Улыбка — это человек который имеет небольшую узнаваемость в комьюнити", "Развитие личности"],
        socials: {
        telegram: "@fuckylibka",
        project: "https://t.me/NoolShy",
        }
    ...
    },
    {
        ...
        category: "Средний фейм",
        role: "Средний фейм",
        description: ".в 2021 году я зашел в троллинг так как слушал разные батлы,в троллинге объяснили о разных кастах в км и так я решился начинать свою карьеру.",
        ...
        skills: [" santy — это человек который имеет небольшую узнаваемость в комьюнити", "Развитие личности"],
        socials: {
            telegram: "@goodsdick",
            project: "https://t.me/+n1pQaKmsk9E5NjVl ",
        }
