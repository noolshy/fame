const members = [
    ...
    },
    {
        ...
        category: "Модераторы",
        role: "Модератор",
        description: "Модератор по заявкам в боте | 3 года назад пришёл в комьюнити,привел сюда друг.было три проекта 2 закрыл 1 основной.травма младший,геноцид,vesmidov.ходил покф,показывал умения осинт,докс",
