...
const members = [
    ...
    },
    {
        id: 2,
        nickname: "francisco",
        username: "@pvpfrancisco - позор",
        category: "я настя дочь шлюхи",
        role: "я настя дочь шлюхи",
        description: "я ебаная шалава которая инстинировала свою смерть подставив подругу",
