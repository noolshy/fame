const members = [
    ...
    },
    {
        ...
        category: "Модераторы",
        role: "Высокий фейм",
        description: "помощник владельца по принятию заявок в боте(фейм листа)ᴄᴇᴏ - @adptTravma, @neimtravma, @ghostlyPr",
    ...
    },
    {
        ...
        joinDate: "2026-01-19",
        activity: "Постоянная",
         details: "увайлд в NoolShy Fame",
        skills: ["увайлд — это человек который имеет небольшую узнаваемость в комьюнити", "Развитие личности"],
        socials: {
        telegram: "@xeewy",
        project: "https://t.me/epiotickm",
        }
    ...
    },
    {
        ...
        category: "Модераторы",
        role: "Средний фейм",
        description: "Модератор по заявкам/В комьюнити с 2023г, привел меня сюда друг, есть проект tpavma end god на 400пдп, связей с феймами не имею, популярность я получил за счет того что я носитель личности травма младший",
    ...
    },
    {
        ...
        category: "Модераторы",
        role: "Модератор",
        description: "Меденжер/Модератор по заявкам в боте | 3 года назад пришёл в комьюнити,привел сюда друг.было три проекта 2 закрыл 1 основной.травма младший,геноцид,vesmidov.ходил покф,показывал умения осинт,докс",
